...
{
    #region Events
    public const string UpdateNotification = "EasingControl.UpdateNotification";
    public const string StateChangeNotification = "EasingControl.stateChangeEvent";
    public const string CompletedNotification = "EasingControl.completedEvent";
    public const string LoopedNotification = "EasingControl.loopedEvent";
    #endregion
    ...
    public void SeekToTime(float time)
    {
        ...
        this.PostNotification(UpdateNotification);
    }
    ...
    void Tick(float time)
    {
        ...
        if (finished)
        {
            ...
            if (loopCount < 0 || loopCount >= loops)
            {
                ...
                this.PostNotification(LoopedNotification);
            }
            else
            {
                this.PostNotification(CompletedNotification);
                Stop();
            }
        }
    }
